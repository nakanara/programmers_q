...
function solution(bill, k, b) {
  ...
  let sum = bill.reduce((t, v, i)=> {
    //console.log(`t=${t} v=${v} i=${i}`)
    if(i === k) return t;
  ...
  // console.log(`sum=${sum} div=${div}/ charge = ${charge}`);
  console.log((charge === 0)? 'Bon Appetit' : charge);
}

console.log( solution([3, 10, 2, 9], 1, 12)); // 5
console.log( solution([3, 10, 2, 9], 1, 7)); // Bon Appetit
